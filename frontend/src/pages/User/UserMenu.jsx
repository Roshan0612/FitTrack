  ...
  return (
    <div className="w-64 bg-gray-100 min-h-screen p-4 shadow-md">
      ...
      <ul className="space-y-4">
        ...
        <li><Link to="/user/dashboard/diets" className="text-gray-700 hover:text-blue-600">View My Diet Plan</Link></li>
        <li><Link to="/auth/login" className="text-red-500 hover:text-red-700" onClick={handleLogout}>Logout</Link></li>
      </ul>
    </div>
  );
};
