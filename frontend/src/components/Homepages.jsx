...
const Homepages = () => {
  ...
  return (
    <div className="home-shell overflow-hidden text-white">
      <section id="home" className="hero-section relative isolate overflow-hidden">
        <div className="hero-grid" />
        <div className="hero-glow hero-glow-left" />
        <div className="hero-glow hero-glow-right" />

        <div className="mx-auto grid min-h-[100svh] w-full max-w-7xl items-center gap-14 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20">
          <motion.div
          ...
          >
            <div className="inline-flex items-center rounded-full border border-white/10 bg-white/6 px-4 py-1.5 text-[11px] uppercase tracking-[0.32em] text-white/72 backdrop-blur-xl">
              <Sparkles className="mr-2 size-3.5 text-emerald-300" />
              Premium fitness operating system
            </div>

            <div className="mt-6 space-y-6">
              <p className="text-sm font-medium uppercase tracking-[0.34em] text-white/40">Built for serious performance</p>
              <h1 className="max-w-4xl text-5xl font-semibold tracking-[-0.06em] text-white sm:text-6xl lg:text-7xl xl:text-[5.8rem]">
                <span className="block">Train with the precision</span>
                <span className="block bg-gradient-to-r from-white via-emerald-200 to-lime-300 bg-clip-text text-transparent">
                  of a luxury product.
                </span>
              </h1>
              <p className="max-w-2xl text-base leading-8 text-white/68 sm:text-lg">
                FitTrack combines elite coaching, subscription management, and member tracking in one refined interface designed to feel premium from the first second.
              </p>
            </div>
          ...
          >
            <motion.div
              ...
              className="relative overflow-hidden rounded-[2rem] border border-white/12 bg-white/5 p-3 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
            >
              ...
              <img
                ...
                className="relative h-[34rem] w-full rounded-[1.6rem] object-cover object-center"
                loading="eager"
              />
            ...
            <motion.div
              className="absolute left-0 top-8 w-44 rounded-3xl border border-white/10 bg-zinc-950/75 p-4 shadow-2xl backdrop-blur-xl"
            ...
            >
              ...
              <p className="mt-3 text-2xl font-semibold tracking-[-0.04em]">1,248</p>
              <p className="text-sm text-white/60">calories burned</p>
            </motion.div>

            <motion.div
              className="absolute -right-2 bottom-12 w-52 rounded-3xl border border-white/10 bg-white/8 p-4 shadow-2xl backdrop-blur-xl"
              initial={{ opacity: 0, x: 24 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">Coach feedback</p>
                  <p className="text-xs text-white/55">96% member satisfaction</p>
                </div>
              </div>
            ...
            <motion.div
              className="absolute -bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/10 bg-white/6 px-4 py-2 text-xs uppercase tracking-[0.28em] text-white/65 backdrop-blur-xl"
              animate={{ y: [0, 6, 0] }}
      ...
      <section id="about" className="section-shell border-b border-white/10 px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div className="max-w-xl">
            ...
            <h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
              Designed like a premium product, built for real training outcomes.
            </h2>
            <p className="mt-5 max-w-xl text-base leading-8 text-white/66 sm:text-lg">
              This redesign turns the old brochure-style layout into a polished system with clearer hierarchy, stronger contrast, and more deliberate motion.
            </p>
          </div>
      ...
      <section id="plans" className="section-shell border-b border-white/10 px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
              Pricing that feels like a premium membership, not a checkout form.
            </h2>
            <p className="mt-5 text-base leading-8 text-white/66 sm:text-lg">
              The subscription flow remains exactly the same. Only the presentation is upgraded to feel more deliberate and commercially polished.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-3">
            {premiumPlanCards.map((plan) => (
              <div
                key={plan._id}
                className={`relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-white/5 text-white shadow-[0_20px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 ${plan.featured ? 'ring-1 ring-emerald-400/35' : ''}`}
              >
                {plan.featured && <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-emerald-300 to-transparent" />}
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    {plan.featured && (
                      <div className="inline-flex items-center rounded-full bg-emerald-400/15 px-3 py-1 text-[11px] uppercase tracking-[0.24em] text-emerald-200">
                        Recommended
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-8">
                    {discountedPrices[plan._id] && discountedPrices[plan._id] !== plan.price ? (
                      <div>
                        ...
                        <p className="mt-1 text-4xl font-semibold tracking-[-0.05em] text-white">₹{plan.currentPrice}</p>
                      </div>
                    ) : (
                      <p className="text-4xl font-semibold tracking-[-0.05em] text-white">₹{plan.currentPrice}</p>
                    )}
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    ) : isAuthenticated && showCouponField[plan._id] && !discountedPrices[plan._id] ? (
                      <>
                        <input
                          type="text"
                    ...
                    {isAuthenticated && (
                      <button
                        type="button"
                        className={`flex h-11 w-full items-center justify-center gap-2 rounded-2xl border text-sm font-semibold transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#05070b] ${plan.featured ? 'border-emerald-300/25 bg-emerald-400 text-zinc-950 shadow-[0_18px_40px_rgba(16,185,129,0.22)] hover:-translate-y-0.5 hover:bg-emerald-300' : 'border-white/12 bg-white/6 text-white hover:-translate-y-0.5 hover:bg-white/10'}`}
                        onClick={() =>
                          handleSubscribe(
                            plan,
                            auth,
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
                The interface should feel premium before the first workout starts.
              </h2>
            </div>
            <p className="max-w-xl text-base leading-8 text-white/64">
              These cards are intentionally calmer, with better spacing and a more editorial feel than the current scattered layout.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {testimonials.map((item, index) => (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="flex size-12 items-center justify-center rounded-full border border-white/10 bg-white/8 text-sm font-semibold text-white">
                      {item.name
                        .split(' ')
                        .map((part) => part[0])
                        .join('')}
                  ...
                  <span className="text-5xl leading-none text-white/12">“</span>
                </div>
                ...
                <p className="mt-4 text-sm leading-7 text-white/68">{item.quote}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.14),transparent_52%),#05070b] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-8 rounded-[2rem] border border-white/10 bg-white/5 px-6 py-12 text-center backdrop-blur-xl sm:px-10 lg:px-16">
          ...
          <h2 className="max-w-3xl text-4xl font-semibold tracking-[-0.06em] text-white sm:text-5xl">
            Build momentum with a platform that feels as serious as your goals.
          </h2>
          <p className="max-w-2xl text-base leading-8 text-white/65 sm:text-lg">
            The business logic stays untouched. The only change here is the experience around it: more clarity, more confidence, and a far more premium first impression.
          </p>
      ...
      <footer className="border-t border-white/10 bg-[#05070b] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          <div>
            <div className="flex items-center gap-3">
              <span className="flex size-10 items-center justify-center rounded-2xl border border-white/10 bg-white/5">
                <Dumbbell className="size-5 text-emerald-300" />
              </span>
              <div>
                <p className="text-sm uppercase tracking-[0.28em] text-white/40">FitTrack</p>
                <p className="text-xl font-semibold tracking-[-0.04em] text-white">Premium fitness, reworked.</p>
              </div>
            </div>
            <p className="mt-5 max-w-md text-sm leading-7 text-white/58">
              A sharper landing experience for fitness users, admins, and members without changing the product logic behind it.
            </p>
          </div>

          <div>
            <h4 className="text-sm uppercase tracking-[0.24em] text-white/40">Quick links</h4>
          ...
          <div>
            <h4 className="text-sm uppercase tracking-[0.24em] text-white/40">Social</h4>
            <div className="mt-4 flex gap-3 text-sm text-white/68">
              <a href="#" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 transition hover:bg-white/10">
                Instagram
              </a>
              <a href="#" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 transition hover:bg-white/10">
                X
          ...
          <div>
            <h4 className="text-sm uppercase tracking-[0.24em] text-white/40">Start now</h4>
            <div className="mt-4 flex flex-col gap-3">
              <Link to="/auth/signup" className={secondaryButtonClass}>
                Create account
              </Link>
          ...
          <div>
            <h4 className="text-sm uppercase tracking-[0.24em] text-white/40">Newsletter</h4>
            <p className="mt-4 text-sm leading-7 text-white/58">
              A lightweight brand block keeps the footer feeling premium without adding unnecessary complexity.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-4 border-t border-white/10 pt-6 text-sm text-white/42 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>Luxury fitness SaaS interface redesign.</p>
        </div>
      </footer>
    </div>
  );
