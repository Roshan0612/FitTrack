        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid items-stretch gap-6 lg:grid-cols-3">
            {premiumPlanCards.map((plan) => (
              <div
                key={plan._id}
                className={`relative flex h-full flex-col overflow-hidden rounded-[1.8rem] border border-white/10 bg-white/5 text-white shadow-[0_20px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 ${
                  plan.featured
